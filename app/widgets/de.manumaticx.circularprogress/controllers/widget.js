...
/**
 * dynamically set the center color
 * @param {String} _color
 */
function setCenterColor(_color) {
	$.centerlayer.backgroundColor = _color;
	$.circleInterior.backgroundColor = _color;
	$.circleExterior.backgroundColor = _color;
}
...
exports.setCenterColor = setCenterColor;
